...
def train(
    ...
    train_dataset = CharDataset(manifest_path=train_path, processor=processor, num_examples=num_train)

    if use_validation:
        if val_path is not None:
            val_dataset = CharDataset(manifest_path=val_path, processor=processor)
        else:
